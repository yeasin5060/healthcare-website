  ...
  return (
    <section id='homecontact'>
        <div className='container'>
            <div className='homecontact_contact_wrapper'>
                <div className='home_contact_heading_box'>
                    <Nanoheading text="Get in touch" style="homecontant_nenohead"/>
                    <Subheading text="Contact" style="homecontant_heading"/>
                </div>
                <div className='home_contact_location_box_flex'>
